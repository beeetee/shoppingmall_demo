...
* a {
	...
	<div class="cotainer" style="margin-bottom: 50px">
		<div class="row justify-content-center">
			<div class="card">
				<form action="editComplete" method="post" enctype="multipart/form-data">
					<table class="table">
						<tbody>
							<tr>
								<td>작성자</td>
								<td>${review.u_id}</td>
								<!--DB에 있는 회원 이름이 표시되도록수정-->
							</tr>
							<tr>
								<td>제목</td>
								<td><input type="text" id="boardtitle" name="boardtitle"
									class="form-control" value="${review.id}" autofocus required></td>
								<!--제목에 해당하는 테이블 컬럼이 어떤것인지?-->
							</tr>
							<tr>
								<td>상품명</td>
								<td><input type="text" id="reviewprodname"
									name="reviewprodname" class="form-control" value="temp" required></td>
							</tr>
							<tr>
								<td>내용</td>
								<td><textarea rows="10" cols="50" value="${review.content}"
